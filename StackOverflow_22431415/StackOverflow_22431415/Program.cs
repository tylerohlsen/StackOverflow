...
namespace StackOverflow_22431415
{
    public class Program
    {
        private static void Main()
        {
            ...
            container.RegisterType<IAuthenticationValidator, MyAuthenticationValidator>(new ContainerControlledLifetimeManager());
            ...
            container.RegisterType<IRequiresAuthentication, MyRequiresAuthentication>(new Interceptor<InterfaceInterceptor>(), new InterceptionBehavior<AuthenticationBehavior>());
